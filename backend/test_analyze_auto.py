#!/usr/bin/env python3
# backend/test_analyze_auto.py

"""
자동 기사 분석 테스트 스크립트 (사용자 입력 불필요)
"""
...
# 테스트용 기사 URL
TEST_URL = "https://n.news.naver.com/mnews/article/001/0014918144"

def test_analyze_auto():
    """기사 분석 자동 테스트"""

    print("\n" + "=" * 80)
    print(f"📰 CR-Check 자동 기사 분석 테스트")
    print("=" * 80)
    print(f"\n기사 URL: {TEST_URL}")
    print("\n⏳ 분석 시작... (40-60초 소요 예상)")
