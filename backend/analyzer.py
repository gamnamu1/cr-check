...
1. **평가 대상 여부 판단 (Eligibility Check)**:
   ...
   - **정치인, 공무원 등 공인(Public Figure)의 발언, SNS 게시글, 성명서 등을 인용하여 전달하는 기사도 '뉴스 보도'로 인정하고 평가합니다.**
   - **주의: "자신의 주장을 펴는 사설/칼럼"과 "타인의 주장을 전달하는 스트레이트 기사"를 명확히 구분하십시오. 전자는 제외하고, 후자는 평가해야 합니다.**
   - **사진 크레딧, 저작권 표기, 제보 안내 등이 포함되어 있어도 본문 내용이 있다면 평가 대상으로 간주하세요.**
   - **평가 제외 대상**:
     - **순수 의견/평론**: (기자나 사설 필진의 주관적 견해가 주가 되는) 사설, 칼럼, 오피니언, 논평.
     - **리뷰/비평**: 서평, 영화/공연/전시 리뷰, 제품 리뷰
     - **단순 정보/홍보**: 날씨, 부고, 인사, 주식 시세, 단순 보도자료, 광고.
     - **문학**: 에세이, 수필, 소설.
