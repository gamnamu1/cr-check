...
* 알림: 뉴스는 어떻게 편집하느냐에 따라 의미가 달라질 수 있습니다. 같은 기사라도 매체에 따라 제목·사진·표의 위치와 크기, 뉘앙스가 달라지고, 연관 기사들을 어떻게 엮는지에 따라 맥락이 달라지기 때문입니다. CR은 개별 기사에 집중하므로, 주변 기사와의 맥락이나 편집 의도는 평가하지 않습니다.
